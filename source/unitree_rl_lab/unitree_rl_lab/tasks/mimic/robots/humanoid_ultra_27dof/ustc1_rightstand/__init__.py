...
gym.register(
    id="USTC-Humanoid-Ultra-27dof-Mimic-houtaitui-tightroll-smoothapex",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.tracking_env_cfg:RobotHoutaituiTightRollSmoothApexEnvCfg"
        ),
        "play_env_cfg_entry_point": (
            f"{__name__}.tracking_env_cfg:RobotHoutaituiTightRollSmoothApexPlayEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": "unitree_rl_lab.tasks.mimic.agents.rsl_rl_ppo_cfg:BasePPORunnerCfg",
    },
)
...
gym.register(
    id="USTC-Humanoid-Ultra-27dof-Mimic-houtaitui-rawroll-smoothapex-2-5kg",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.tracking_env_cfg:RobotHoutaituiRawRollSmoothApexLeftArm2P5kgEnvCfg"
        ),
        "play_env_cfg_entry_point": (
            f"{__name__}.tracking_env_cfg:RobotHoutaituiRawRollSmoothApexLeftArm2P5kgPlayEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": "unitree_rl_lab.tasks.mimic.agents.rsl_rl_ppo_cfg:BasePPORunnerCfg",
    },
)
