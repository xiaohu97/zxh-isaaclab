...
int main(int argc, char** argv)
{
    ...
    FSMState::lowcmd->msg_.mode_machine() = 6; // 5 29dof   6 27dof
    ...
    std::cout << "如果遇到紧急情况进入阻尼 Passive:  按住 LT + B.on_pressed.\n";
    std::cout << "跳舞动作1 :  Mimic_Dance_102: LT(2s) + down.on_pressed.\n";
    std::cout << "跳舞动作2 :  Mimic_Gangnam_Style: LT(2s) + left.on_pressed.\n";
